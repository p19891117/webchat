	...
	<div class="container-fluid">
		<div class="row">
		  <div class="col-md-2">
				...
				<button type="button" class="btn btn-primary" id="conn">上线</button>
				<button type="button" class="btn btn-primary" id="disconn" disabled="disabled">下线</button>
		...
		<div class="row">
		  <div class="col-md-12"><button type="button"  class="btn btn-primary" disabled="disabled" id="send">发送</button></div>
		</div>
	</div>
</body>
...
<script type="text/javascript" src="js/sockjsClient.js"></script>
